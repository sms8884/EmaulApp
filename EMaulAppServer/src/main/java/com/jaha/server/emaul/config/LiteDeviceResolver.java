...
/**
 * <pre>
 * Class Name : LiteDeviceResolver.java
...
public class LiteDeviceResolver implements DeviceResolver {
     ...
     * (non-Javadoc)
     *
     * @see org.springframework.mobile.device.DeviceResolver#resolveDevice(javax.servlet.http.HttpServletRequest)
     */
    @Override
    ...
    /**
     * Fallback called if no mobile device is matched by this resolver. The default implementation of this method returns a "normal" {@link Device} that is neither mobile or a tablet. Subclasses may
     * override to try additional mobile or tablet device matching before falling back to a "normal" device.
     */
    ...
    private static final String[] KNOWN_MOBILE_USER_AGENT_PREFIXES = new String[] {"w3c ", "w3c-", "acs-", "alav", "alca", "amoi", "audi", "avan", "benq", "bird", "blac", "blaz", "brew", "cell",
            "cldc", "cmd-", "dang", "doco", "eric", "hipt", "htc_", "inno", "ipaq", "ipod", "jigs", "kddi", "keji", "leno", "lg-c", "lg-d", "lg-g", "lge-", "lg/u", "maui", "maxo", "midp", "mits",
            "mmef", "mobi", "mot-", "moto", "mwbp", "nec-", "newt", "noki", "palm", "pana", "pant", "phil", "play", "port", "prox", "qwap", "sage", "sams", "sany", "sch-", "sec-", "send", "seri",
            "sgh-", "shar", "sie-", "siem", "smal", "smar", "sony", "sph-", "symb", "t-mo", "teli", "tim-", "tosh", "tsm-", "upg1", "upsi", "vk-v", "voda", "wap-", "wapa", "wapi", "wapp", "wapr",
            "webc", "winw", "winw", "xda ", "xda-"};

    private static final String[] KNOWN_MOBILE_USER_AGENT_KEYWORDS = new String[] {"blackberry", "webos", "ipod", "lge vx", "midp", "maemo", "mmp", "mobile", "netfront", "hiptop", "nintendo DS",
